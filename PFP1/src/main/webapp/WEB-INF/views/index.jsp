...
<div class="slider-wrap home-1-slider">
	<div id="mainSlider" class="nivoSlider slider-image">
		<img src="<%=request.getContextPath() %>/img/slider/1.jpg" alt="main slider" title="#htmlcaption1"/>
		<img src="<%=request.getContextPath() %>/img/slider/2.jpg" alt="main slider" title="#htmlcaption2"/>
	</div>
				...
				<div class="feature-pro-slider owl-carousel">
					...
					<div class="product-item fix">
						<div class="product-img-hover">
							<!-- Product image -->
							<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/featured/1.jpg" alt="featured" /></a>
							<!-- Product action Btn -->
					...
					<div class="product-item fix">
						<div class="product-img-hover">
							<!-- Product image -->
							<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/featured/2.jpg" alt="featured" /></a>
							<!-- Product action Btn -->
							<div class="product-action-btn">
								<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
								<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
					...
					<div class="product-item fix">
						<div class="product-img-hover">
							<!-- Product image -->
							<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/featured/3.jpg" alt="featured" /></a>
							<!-- Product action Btn -->
							<div class="product-action-btn">
								<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
								<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
					...
					<div class="product-item fix">
						<div class="product-img-hover">
							<!-- Product image -->
							<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/featured/4.jpg" alt="featured" /></a>
							<!-- Product action Btn -->
							<div class="product-action-btn">
								<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
								<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
...
<div class="banner-area fix"><!-- Product Offer Area Start -->
	<div class="col-sm-6 sin-banner">
		<a href="#">
			<img src="<%=request.getContextPath() %>/img/offer/offer-1.jpg" alt="" />
			<div class="wrap">
				<h2>Bracelets</h2>
	...
	<div class="col-sm-4 sin-banner">
		<a href="#">
			<img src="<%=request.getContextPath() %>/img/offer/offer-2.jpg" alt="" />
			<div class="wrap">
				<h2>Earrings</h2>
				<p>perspiciatis unde omnis iste natus error sit voluptatem accm doloremque antium</p>
			</div>
	...
	<div class="col-sm-2 hidden-xs sin-banner text-1">
		<img src="<%=request.getContextPath() %>/img/offer/banner-bg.jpg" alt="" />
	...
	<div class="col-sm-2 hidden-xs sin-banner clear text-2">
		<img src="<%=request.getContextPath() %>/img/offer/banner-bg-2.jpg" alt="" />
		<div class="banner-text">
	...
	<div class="col-sm-6 sin-banner">
		<a href="#">
			<img src="<%=request.getContextPath() %>/img/offer/offer-3.jpg" alt="" />
			<div class="wrap">
				<h2>Rings</h2>
				<p>perspiciatis unde omnis iste natus error sit voluptatem accm doloremque antium</p>
			</div>
	...
	<div class="col-sm-4 sin-banner">
		<a href="#">
			<img src="<%=request.getContextPath() %>/img/offer/offer-4.jpg" alt="" />
			<div class="wrap">
				<h2>Necklaces</h2>
				<p>perspiciatis unde omnis iste natus error sit voluptatem accm doloremque antium</p>
			</div>
					...
					<div class="tab-pro-slider new-product owl-carousel">
						<div class="single-product-item fix">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/1.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/2.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
						...
						<div class="single-product-item fix">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/6.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
						...
						<div class="single-product-item fix">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/7.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
						...
						<div class="single-product-item fix">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/4.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
					...
					<div class="tab-pro-slider best-product owl-carousel">
						<div class="single-product-item">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/10.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
					...
					<div class="tab-pro-slider trending-product owl-carousel">
						...
						<div class="single-product-item">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/9.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
						...
						<div class="single-product-item">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/8.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
						...
						<div class="single-product-item">
							...
							<div class="product-item fix">
								<div class="product-img-hover">
									<!-- Product image -->
									<a href="product-details.html" class="pro-image fix"><img src="<%=request.getContextPath() %>/img/product/3.jpg" alt="product" /></a>
									<!-- Product action Btn -->
									<div class="product-action-btn">
										<a class="quick-view" href="#"><i class="fa fa-search"></i></a>
										<a class="favorite" href="#"><i class="fa fa-heart-o"></i></a>
...
<div class="magic-area fix"><!--Start Magic Area-->
	<div class="col-sm-12 col-md-6 image">
		<a href="#"><img src="<%=request.getContextPath() %>/img/magic.jpg" alt="magic" /></a>
	</div>
			...
			<div class="blog-slider owl-carousel">
				<div class="single-blog">
					<div class="content fix">
						<a class="image fix" href="blog-details.html"><img src="<%=request.getContextPath() %>/img/blog/blog-1.jpg" alt="" />
							<div class="date">
								<h4>25</h4>
								<h5>Aug</h5>
							</div>
				...
				<div class="single-blog">
					<div class="content fix">
						<a class="image fix" href="blog-details.html"><img src="<%=request.getContextPath() %>/img/blog/blog-2.jpg" alt="" />
							<div class="date">
								<h4>25</h4>
								<h5>A<%=request.getContextPath() %>/img/h5>
							</div>
						</a>
						<h2><a class="title" href="blog-details.html">Lorem ipsum dolor sit amet</a></h2>
						<div class="meta">
				...
				<div class="single-blog">
					<div class="content fix">
						<a class="image fix" href="blog-details.html"><img src="<%=request.getContextPath() %>/img/blog/blog-3.jpg" alt="" />
							<div class="date">
								<h4>25</h4>
								<h5>Aug</h5>
							</div>
				...
				<div class="single-blog">
					<div class="content fix">
						<a class="image fix" href="blog-details.html"><img src="<%=request.getContextPath() %>/img/blog/blog-4.jpg" alt="" />
							<div class="date">
								<h4>25</h4>
								<h5>Aug</h5>
							</div>
				...
				<div class="col-sm-offset-0 col-sm-12 col-md-offset-2 col-md-8">
					<div class="testimonial-slider  owl-carousel">
						<div class="testimonial-item">
							<div class="image fix">
								<img src="<%=request.getContextPath() %>/img/testimonial/testimonial.jpg" alt="" />
							</div>
							<div class="content fix">
	...
	<div class="container">
		<div class="row">
			...
			<div class="brand-slider owl-carousel">
				...
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-3.png" alt="" /></div>
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-4.png" alt="" /></div>
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-5.png" alt="" /></div>
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-1.png" alt="" /></div>
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-2.png" alt="" /></div>
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-3.png" alt="" /></div>
				<div class="brand-item"><img src="<%=request.getContextPath() %>/img/brand/brand-4.png" alt="" /></div>
